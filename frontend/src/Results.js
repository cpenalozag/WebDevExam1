                                    ...
                                    <div className="card">
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-8">
                                                ...
                                                <p><strong>Followers:</strong> {this.props.user2.edge_followed_by.count}</p>
                                                <p><strong>Total likes:</strong> {this.props.user2.totalLikes}</p>
                                                <p><strong>Number of pictures:</strong> {this.props.user2.edge_owner_to_timeline_media.count}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
